...
export function Sidebar() {
  return (
    <aside className="min-h-svh sticky top-0 hidden md:flex justify-start items-center flex-col w-fit p-4 h-full bg-secondary_color_2">
      ...
      <div className="flex space-y-2 mt-10 justify-center items-center flex-col w-full">
        <Link href="/dashboard" className="w-full">
          <Button className="w-full bg-primary_color" variant="default">
            Dashboard
          </Button>
        </Link>
