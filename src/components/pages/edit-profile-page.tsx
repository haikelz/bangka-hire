    ...
    <Layout>
      <div className="bg-secondary_color_2 p-2 md:p-10 rounded-md space-y-3 md:space-y-6 mt-6">
        ...
        <div className="space-y-2">
          <h1 className="uppercase text-primary_color text-sm md:text-base">
            Informasi Profil
          </h1>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <ModalFormTentangSaya
              openModal={openModalTentangSaya}
              setOpenModal={setOpenModalTentangSaya}
              userInfo={data?.user}
            />
          </div>
