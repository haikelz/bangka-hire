...
type ModalCreateJobApplicantProps = {
  openModal: boolean;
...
export function ModalCreateJobApplicant({ openModal, setOpenModal }: ModalCreateJobApplicantProps) {
  ...
  const createJobApplicantMutation = useMutation({
    mutationFn: async () =>
          ...
          <div className="space-y-2 md:space-y-4 w-full">
            ...
            <div className="flex items-center justify-end">
              <Button
                ...
                disabled={createJobApplicantMutation.isPending}
              >
                {createJobApplicantMutation.isPending ? (
