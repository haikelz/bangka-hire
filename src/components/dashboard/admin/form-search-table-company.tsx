    ...
    <div className="flex justify-between items-center">
      ...
      <form onSubmit={handleSubmit} className="w-1/3">
        <div className="relative">
          <Input placeholder="Search Company" name="search-company" id="search-company" className=" border-primary_color pl-10" />
        ...
        {isPending ? (
          ...
          <tr>
            <td colSpan={5} className="pt-4 font-medium text-lg text-center">
              <span className="text-gray-500">Perusahaan tidak ditemukan</span>
            </td>
          </tr>
        )}
      </tbody>
